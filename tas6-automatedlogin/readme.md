...
-- Description:
-- This task demonstrates automated audit logging using
-- database TRIGGERS and reporting using VIEWS.
-- Every INSERT and UPDATE operation is logged automatically,
-- and a daily activity report is generated using a VIEW.
...
-- Main table where operations occur
...
FOR EACH ROW
BEGIN
    INSERT INTO audit_log (action_type, record_id)
...
INSERT INTO main_table (name, amount)
VALUES ('Order1', 1500);
